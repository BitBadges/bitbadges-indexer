...
<div style="font-family: inherit; text-align: inherit"><span style="font-size: 12px">Please make sure this matches the one you set in your BitBadges account.</span></div>
...
export const SaveForLaterValueHTML = (body: string) => {
  return `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
    <head>
...
<![endif]-->
  ...
  <![endif]-->  
    ...
    <tbody>
      <tr>
        <td style="padding:12px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content">
${body}
</td>
      </tr> 
    </tbody>
